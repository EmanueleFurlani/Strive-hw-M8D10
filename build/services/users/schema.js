...
// import { UserDocument, UserModelType } from "src/typings";
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    if (!newUser.isModified("password")) return [3 /*break*/, 2];
                    // only if user is modifying the password we are going to use CPU cycles to calculate the hash
                    _a = newUser;
                    return [4 /*yield*/, bcrypt_1.default.hash(plainPW, 10)];
                case 1:
                    // only if user is modifying the password we are going to use CPU cycles to calculate the hash
                    _a.password = _b.sent();
                    _b.label = 2;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, bcrypt_1.default.compare(plainPW, user.password)];
                case 2:
                    isMatch = _a.sent();
